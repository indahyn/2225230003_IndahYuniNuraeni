...
<body>
    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        <nav class="navbar navbar-expand-lg bg-primary py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
                <h1 class="display-5 text-primary m-0">Beritaku</h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="{{ url('beritadaftar') }}" class="nav-item nav-link text-white">Berita</a>
                    <a href="{{ url('login') }}" class="nav-item nav-link text-white">Login Admin</a>
                </div>
            </div>
        </nav>
    </div>
