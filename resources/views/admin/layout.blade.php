    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{ url('panel/kategoridaftar') }}" aria-expanded="false">
                            <i class="icon-screen-tablet menu-icon"></i><span class="nav-text">Kategori</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('panel/beritadaftar') }}" aria-expanded="false">
                            <i class="icon-list menu-icon"></i><span class="nav-text">Berita</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="footer">
            <div class="copyright">
                <p>Dibuat oleh : 2225230003_IndahYuniNuraeni</p>
            </div>
        </div>
        <!--**********************************
            Footer end
